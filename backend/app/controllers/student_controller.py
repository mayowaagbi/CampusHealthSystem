...
async def schedule_appointment(
    ...
    try:
        return await StudentController.schedule_appointment(current_user.id, appointment)
    except ValueError as e:
        raise HTTPException(status_code=400, detail=str(e))
...
async def cancel_appointment(
    ...
    try:
        return await StudentController.cancel_appointment(current_user.id, appointment_id)
    except ValueError as e:
        raise HTTPException(status_code=400, detail=str(e))
...
async def delete_journal(
    journal_id: int , current_user=Depends(get_current_user)
):
...
async def create_emergency_contact(
    ...
    try:
        return await StudentController.create_emergency_contact(current_user.id, contact)
    except ValueError as e:
        raise HTTPException(status_code=400, detail=str(e))
...
async def update_emergency_contact(
    ...
    try:
        return await StudentController.update_emergency_contact(current_user.id, contact_id, contact_update)
    except ValueError as e:
        raise HTTPException(status_code=400, detail=str(e))
...
async def delete_emergency_contact(
    ...
    try:
        return await StudentController.delete_emergency_contact(current_user.id, contact_id)
    except ValueError as e:
        raise HTTPException(status_code=400, detail=str(e))
...
async def submit_feedback(
    ...
    try:
        ...
        raise HTTPException(status_code=400, detail=str(e)) ```python
